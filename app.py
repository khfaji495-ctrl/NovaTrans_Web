                    ...
                    for b in blocks:
                        ...
                        if text.strip() and not is_equation:
                            try:
                                ...
                                # رسم مستطيل خلفية للوضوح
                                page.draw_rect([x0, y1, x0 + 200, y1 + 15], color=(1, 1, 1), fill=(1, 1, 1))
                                # كتابة النص
                                page.insert_text((x0, y1 + 12), arabic, fontsize=9, fontname="ArabicFont", color=(0, 0, 0))
                            except:
                                continue
